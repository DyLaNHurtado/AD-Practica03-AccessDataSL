...
class RepoIssueTest {
    ...
    static void init(){
        list.add(new Issue("1f9b764e-570f-4041-a0c9-fc58a794eb0d", "arreglo 1", "se ha encontrado un fallo en la clase",
                LocalDate.now(), List.of("53269670-1586-49ac-9df5-62ddd55f96cc;1376acc9-79a9-4bf1-9084-c82e9a07f432"),
        ...
        list.add(new Issue("7e96e277-26bc-4c08-a21e-6d92eb7638de", "arreglo 2", "se ha encontrado un fallo en el atributo",
                LocalDate.now(), List.of("d63f0d73-3f1b-4afd-b5d0-821449daa4a3"),
        ...
        list.add(new Issue("6c5b7c5a-d30b-400f-9c11-84dc2b49f01e", "arreglo 3", "se ha encontrado un fallo en el metodo",
                LocalDate.now(), List.of("606aba4c-b76e-4fa3-9eb8-48e20d729353"),
    ...
    void save() throws SQLException {
        Issue issue =new Issue("","","",LocalDate.now(),List.of(""),"","","");
    ...
    void update() throws SQLException {
        Issue issue =new Issue("","1","1", LocalDate.now(),List.of(""),"","","");
